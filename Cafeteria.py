...
def factura_final(factura, nombre, cedula):
 ...
 print("Por favor seleccione su metodo de pago")
 print("1. Efectivo")
 print("2. Tarjeta")
 ...
 if metodo == "1":
  ...
  print("Su metodo de pago no es valido.")
 confirmar = input("Por favor indique si desea confirmar su pedido? (a. Si/ b. No):") 
 if confirmar == "a":
  subtotal = factura
  iva = subtotal * 0.15
  total = subtotal + iva
  ...
  print("*************FACTURA*************")
  mostrar_factura(Cliente=nombre, CI_RUC=cedula, Subtotal=subtotal, IVA=iva, TOTAL=total)
...
factura = 0
print("Antes de comenzar con su pedido, por favor ingrese su informacion")

nombre = input("Ingrese su nombre: ")
cedula = input("Ingrese su CI/RUC: ")

print("Bienvenido/a a Pink Dream,", nombre)
...
while True:
  ...
  if opcion == "a":
   ...
   print("Opcion no valida, por favor ingrese una de las opciones del menu")
if factura > 0:
